...
$count="SELECT *  FROM events where id=?";
 ...
 <body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"><a href="indexStu.html" class="nav-link">Home</a></li>
          ...
          <li class="nav-item cta"><a href="logout.php" class="nav-link"><span>Apply Now!</span></a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
        	<div class="col-md-20 d-flex ftco-animate">
          <div class="col-md-20 d-flex ftco-animate">
          	<div class="blog-entry d-md-flex align-self-stretch flex-column-reverse">
              <a href="blog-single.html" class="block-20 align-self-end" style="background-image: url('<?php echo $img ?>');">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#"><?php echo $date ?> &nbsp <?php echo $month ?> &nbsp <?php echo $year ?></a></div>
				  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
                  
                </div>
                <h3 class="heading mb-4"><a href="#"><?php echo $name ?></h3>
                <p class="time-loc"><span class="mr-10"><i class="icon-clock-o"></i><?php echo $time ?> &nbsp &nbsp &nbsp</span> <span><i class="icon-map-o"></i><?php echo $venue ?></span></p>
                <p><?php echo $description ?></p>
                <p><a href="registerS.html">Join Event <i class="ion-ios-arrow-forward"></i></a></p>
              </div>
            </div>
          </div>
    </section>
