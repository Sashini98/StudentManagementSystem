  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"><a href="indexTeacher.html" class="nav-link">Home</a></li>
          <li class="nav-item"><a href="about.html" class="nav-link">About</a></li>
          <li class="nav-item"><a href="course.html" class="nav-link">Courses</a></li>
		  		  <li class="nav-item"><a href="signupS.html" class="nav-link">Add Student</a></li>
    ...
    <section class="ftco-section">
    	<div class="container">
			...
			&nbsp &nbsp EVENTS &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp     
              <?Php
	           ...
	           if ($conn->connect_error) 
                ...
                echo "<tr><td><ul>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a href=details.php?id=$nt[id]>$nt[name]</a></ul></td></tr>";
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
                ...
                <p>Internet of Things is a new revolution of the Internet. A world where the real, digital and the virtual are converging..</p>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
                ...
                <p>In order to raise the interest of the youth on IT and to promote the development and popularization of IT..</p>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
              <h2>Subcribe to  stay updated</h2>
        ...
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
              <h2><a class="navbar-brand" href="index.html"><i class="flaticon-university"></i>NIBM <br><small>Institute</small></a></h2>
              <p>Powering up with the change.</p>
          ...
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">No: 120/5,
                    Wijerama (Vidya) Mawatha,
                    Colombo 07, Sri Lanka.</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+94 117 321 000</span></a></li>
